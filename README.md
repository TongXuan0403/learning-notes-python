...
**当前进度：Day 2 / 30（2026-09-15，已完成容器数据类型五类，下一步 D3 函数）**
...
| 一、基础语法 | Day 2 | 09-15 | 容器数据类型：字符串 str（赶进度，D2 一天覆盖 list/str/tuple/set/dict 五类） | `学习/3` `review/day02_review.py` | 丰富的数据类型 + 容器分层 10 题 | 已完成 |
...
| 一、基础语法 | Day 6 | 09-19 | 函数基础：定义 / 调用 / 参数 / 返回值 / 说明文档 | `学习/4` | 神奇的函数（部分） | 待开始 |
| 一、基础语法 | Day 7 | 09-20 | 函数进阶：嵌套 / 作用域 / 递归 / 匿名函数 | `学习/4` | 神奇的函数 9 题 | 待开始 |
| 一、基础语法 | Day 8 | 09-21 | 文件操作：打开关闭 / 文件读写 / 常用函数 / 文件拷贝 | `学习/5` | — | 待开始 |
| 二、面向对象与异常 | Day 9 | 09-22 | 错误与异常：try-except / raise / 自定义异常 | `学习/7` | — | 待开始 |
| 二、面向对象与异常 | Day 10 | 09-23 | 模块与包：import / 包结构 / 模块使用 | `学习/8` | — | 待开始 |
| 二、面向对象与异常 | Day 11 | 09-24 | 标准模块实战：math / random 等 | `学习/8` | 标准模块 3 题 | 待开始 |
| 二、面向对象与异常 | Day 12 | 09-25 | 面向对象：类与对象 / 属性 / 方法 / `__init__` | `学习/6` | — | 待开始 |
| 二、面向对象与异常 | Day 13 | 09-26 | 面向对象：封装 | `学习/6` | — | 待开始 |
| 二、面向对象与异常 | Day 14 | 09-27 | 面向对象：继承 | `学习/6` | — | 待开始 |
| 二、面向对象与异常 | Day 15 | 09-28 | 面向对象：多态 + 综合练习 | `学习/6` | — | 待开始 |
...
| 三、高级主题 | Day 19 | 10-02 | 进程与线程：多进程 / 多线程 / 对比 | `学习/10` | — | 待开始 |
...
│   ├── 10 进程与线程/
│   └── 11 正则表达式/
├── review/                      # 每日「知识速整 + 分层题目」代码（dayXX_review.py）
├── 刷题/                        # 刷题练习
